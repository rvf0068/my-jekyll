...
Let's start with some simple Python examples to get familiar with the interactive cells.
...
The interactive computing capabilities demonstrated here complement the theoretical foundations shown in the [[file:2025-11-16-mathematical-foundations.org][Mathematical Foundations]] post and the programming techniques from the [[file:2025-11-16-programming-showcase.org][Programming Showcase]].

Check if this links work: [[file:2025-11-16-mathematical-foundations.org][Math post]].
